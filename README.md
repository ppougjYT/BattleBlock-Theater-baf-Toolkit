...
This repository contains Python scripts for extracting and packing BAF (Baldur's Gate Archive File) archives. BAF files are compressed archives used in some older games, such as those in the Infinity Engine series (e.g., Baldur's Gate).
